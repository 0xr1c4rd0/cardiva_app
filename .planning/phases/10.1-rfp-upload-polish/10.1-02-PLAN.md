...
4. Verify counts reflect actual job states in database
  </verify>
  <done>
- RFPs page shows exactly 3 KPI chips: Por Rever, Revistos, Confirmados
- Counts accurately reflect the 3-state model
...
6. Navigate to /rfps - Confirmados KPI should increment
  ...
  <done>
- confirmRFP server action exists and updates confirmed_at
